...
class DatabaseHelper {
  ...
  Future<int> updateReservation(
      int id, Map<String, dynamic> reservation) async {
    final db = await instance.database;
  ...
  Future<int> insertCustomer(Map<String, dynamic> customer) async {
    ...
    if (kDebugMode) {
      print(
          '👤 Customer inserted: ID=$id, Number=${customer['customer_number']}');
    }

    return id;
  }

  Future<Map<String, dynamic>?> getCustomerByNumber(
  ...
  Future<List<Map<String, dynamic>>> getCustomersBySegment(
  ...
  Future<Map<String, int>> getReservationStats() async {
    ...
    final stats = <String, int>{
      'total_reservations':
          (await db.rawQuery('SELECT COUNT(*) as count FROM reservations'))
              .first['count'] as int,
